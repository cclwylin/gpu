...
L2CacheLt::L2CacheLt(sc_core::sc_module_name name)
    : sc_module(name), target("target"), initiator("initiator") {
    target.register_b_transport(this, &L2CacheLt::b_transport);
}

void L2CacheLt::b_transport(tlm::tlm_generic_payload& trans,
    ...
    delay += sc_core::sc_time(4.0, sc_core::SC_NS);
